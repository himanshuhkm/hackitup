...
<body>
  ...
  <div class="container">
    ...
    <span class="txt anim-text-flow"><?echo 'Use "Pastarnak" Browser to access this page from';?></span><p id="location">Eiffel Tower</p>
    <span class="txt anim-text-flow"><?if($coun==='France'){ echo "NOOBHAITU.php";}?></span>
