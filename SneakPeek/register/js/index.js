...
var questions = [
    ...
    {question:"Department you study in?"},
    {question:"Your current year of study?"},
    {question:"Your class section in college?"},
    {question:"Enter a password", type: "password"},
    {question:"Re-enter your password", type: "password"}
  ]
  ...
  var onComplete = function() {
      ...
      $.ajax({
          ...
          data: {
              ...
              confirmpassword: questions[9].answer
          },
          success: function (response) {
              document.getElementById("loading-spinner").style.visibility = "hidden";
              h1.appendChild(document.createTextNode('Welcome to Hack It Up 2.0, ' + questions[0].answer + '!'))
          },
          error: function(xhr, textStatus, errorThrown) {
              ...
              if (xhr.status == 409) {
                  ...
                  h1.appendChild(document.createTextNode('Your passwords do not match. Please try again!'))
              }
              else {
