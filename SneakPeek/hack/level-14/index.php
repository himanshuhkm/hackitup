...
<body>
  ...
  <div class="container">
  	...
  	<span class="txt anim-text-flow"><?echo 'However, he does not know the vulnerabilities of a text box';?></span>
  	<span class="txt anim-text-flow"><?echo 'Maybe you could alert him?';?></span>
  	<div class="search">
		<input id="term" type="text" placeholder="This lets you print " class="form-control" />
