...
<head>
  <meta charset="UTF-8">
  <title>Hack It Up Sneak Peek | Level 10</title>
...
<body>
  ...
  <div class="container">
  <span class="txt anim-text-flow">The network security engineer Dhanya fired the intern </span>
  <br/ >
  <span class="txt anim-text-flow">and hired another. This new guy is the real deal.</span>
  <br/ >
  <span class="txt anim-text-flow">He is not the one to be messed with. Think you're smarter?</span>
  <br />
  <center>
  <div class="font-sans">
      <div class="w-xs bg-white p-6 shadow-md rounded max-w-sm">
            <form method="post" action="checklogin.php">
                ...
                <div class="mb-4">
                    <div><label class="block text-grey-darker text-sm font-bold mb-2 required" for="_password">Password</label><input type="password" id="_password" name="_password" required="required" placeholder="Password" class="border-2 rounded w-full p-2 text-grey-darker leading-tight focus:border-grey-dark"/></div><a href="level10.txt" rel="nofollow" download="level10.txt"></a>
                </div>
