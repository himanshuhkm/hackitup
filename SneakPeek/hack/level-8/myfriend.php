  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div class="container">
  	<span class="txt anim-text-flow">
  	    <?php 
  	        if ($_GET["food"]=="KQxAKtsZUd") {
  	            echo "Phewww! That was soooo tasty. Thank you so much. Go to trynalogin.php and get it yourself!";
  	        }
  	        else {
  	            echo "I want food! What part did you not understand?";
  	        }
  	    ?>
  	</span>
