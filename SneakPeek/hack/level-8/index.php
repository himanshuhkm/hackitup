...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <div class="container">
  	<span class="txt anim-text-flow">Hi! I was told that you'd come looking for a token.</span>
  	<br/>
  	<span class="txt anim-text-flow">The problem is that the token is with my friend, and oh boy, he's so hungry!</span>
  	<br/>
  	<span class="txt anim-text-flow">If you get to him before I do and 'feed my friend', he'll probably give it to you. </span>
</div>
