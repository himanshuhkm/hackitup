...
<head>
  <meta charset="UTF-8">
  <title>Hackbox v2 | Level 2</title>
...
<body>
  ...
  <div class="container">
  <span class="txt anim-text-flow">Alert the webpage using the form below!</span>
  <br />
  <center>
  <div class="font-sans">
      <div class="w-xs bg-white p-6 shadow-md rounded max-w-sm">
            <form method="post" action="checklogin.php">
                <div class="mb-4">
                    <div><label class="block text-grey-darker text-sm font-bold mb-2 required" for="_feedback">Post a story</label><input type="text" id="_feedback" name="_feedback" required="required" placeholder="Username" autofocus="autofocus" class="border-2 rounded w-full p-2 text-grey-darker leading-tight focus:border-grey-dark" /></div>
                </div>
